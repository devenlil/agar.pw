...
GameServer.prototype.getCrossdomain = function() {
    var cd = '<?xml version="1.0"?><!DOCTYPE cross-domain-policy SYSTEM "http://www.adobe.com/xml/dtds/cross-domain-policy.dtd"><cross-domain-policy><site-control permitted-cross-domain-policies="all"/><allow-access-from domain="*.agar.pw" secure="false" /><allow-http-request-headers-from domain="*.agar.pw" headers="*"/></cross-domain-policy>';
    this.crossdomain = cd;
};
